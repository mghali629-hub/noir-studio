...
const items = [
  { id: 3, name: 'Cashmere Oversized Turtleneck', price: '€920', image: 'https://images.unsplash.com/photo-1576566588028-4147f3842f27?w=600&q=80', desc: '100% Mongolian organic cashmere knitted in 7-gauge heavy rib structure.' },
  { id: 4, name: 'Merino Ribbed Pullover Sweater', price: '€540', image: 'https://images.unsplash.com/photo-1434389677669-e08b4cac3105?w=600&q=80', desc: 'Superfine Merino wool sweater with relaxed drop-shoulder silhouette.' },
];
    ...
    <div className="min-h-screen bg-[#0e0e0e] text-[#f0ece3] font-sans flex flex-col">
      ...
      <main className="max-w-6xl mx-auto px-4 py-20 flex-1 space-y-10">
        <div>
          ...
          <h1 className="text-4xl font-light mt-3 mb-2">Artisanal Knitwear</h1>
          <p className="text-gray-400 text-xs">Heavy gauge cashmere turtlenecks and superfine merino pullovers.</p>
        </div>
